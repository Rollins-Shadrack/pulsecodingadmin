...
const customStyles = {
  ...
  return (
    <Card className=" mt-5 mb-3 shadow-md">
      <CardHeader>
        ...
        <div className="p-10 min-h-[500px] my-5  border-gray-200 relative w-full">
          <Resize handleWidth="3px" handleColor="#777">
            <ResizeHorizon width="50%" style={{ backgroundColor: "lightblue" }}>
              <p className="text-justify pr-8 mx-auto mb-2 overflow-y-auto no-scrollbar">
                ...
                aliquid dolor repellendus, magnam, facere adipisci nostrum pariatur nam temporibus unde nemo animi necessitatibus neque quaerat
                debitis quo. Voluptate reprehenderit odio quidem quibusdam tenetur velit error cumque, deserunt provident optio ut labore omnis?
                Expedita possimus natus porro nihil culpa nam aliquid perferendis ullam, maxime, iste non ad voluptatibus tempore in fugiat incidunt
                dolorem, vero nobis et. Explicabo mollitia nobis placeat ipsum.
              </p>
