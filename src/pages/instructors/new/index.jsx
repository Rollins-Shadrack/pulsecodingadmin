...
import { newInstructor } from "@/lib/validations/newUsers";
...
const index = () => {
  const form = useForm({
    resolver: yupResolver(newInstructor),
    defaultValues: {
      firstName: "",
      lastName: "",
      gender: '',
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Proffesional Title</FormLabel>
                      <FormControl>
                        <Input placeholder="Proffesional Title" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
