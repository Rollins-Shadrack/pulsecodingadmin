...
import { ClipboardPenLine, Eye, UserPlus, Users } from 'lucide-react';
        ...
        <CardHeader className="py-3 ">
          <div className="md:flex items-center justify-between">
            <CardTitle className="md:text-2xl text-lg mb-3 my-auto flex items-center">
              All Instructors <Users className="w-5 h-5 ml-2" />
            </CardTitle>
            <Link to="new">
              <Button className="bg-green-600 hover:bg-green-600 flex items-center">
                Add Instructor <UserPlus className="w-4 h-4 ml-2" />
              </Button>
            </Link>
          </div>
        </CardHeader>
